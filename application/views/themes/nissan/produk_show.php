    ...
    <div class="article">
        <div class="row">
            <div class="col-xs-12 col-md-8 col-lg-8">
				...
				<header>
					<h2 itemprop="name">OUR PRODUCT</h2>
					<span class="borderline"></span>
				</header>

        <h2><?php echo $query->produk_title;?></h2>
        <span class="label label-info"> Administrator</span>
        <span class="label label-info"><i class="glyphicon glyphicon-calendar"></i> <?php echo date('d/m/Y H:i',strtotime($query->input_date));?> WIB</span>
        <hr>
				<iframe src="<?php echo site_url('modproduk/get_pict/'.$query->id);?>" width="750" height="500" frameborder="0" style="border:0" allowfullscreen></iframe>
        <hr>
        <h4><i class="glyphicon glyphicon-list-alt"></i> Detail Produk</h4>
        <div class="article-post-content">
          <?php echo $query->produk_desc;?>  
        </div>
		</div>
