...
<div class="row">
	<div class="col-lg-12 col-sm-12 col-xs-12">
			...
			<div class="panel panel-primary">
				<div class="panel-heading"><i class="glyphicon glyphicon-home"></i> <b>Add New Picture</b></div>
				<div class="panel-body">
				<?php echo form_open('modgallery/addgallery');?>
					...
					<tr>
                        ...
                        <th width="45%">
                           <div class="col-md-6 col-xs-6">
                               <input type="text" name="featuredimage" value="" id="featuredimage" class="form-control" readonly="readonly"  required />
                           </div>
