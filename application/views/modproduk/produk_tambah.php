...
<div class="row">
	<div class="col-lg-12 col-sm-12 col-xs-12">
			...
			<div class="panel panel-primary">
				<div class="panel-heading"><i class="glyphicon glyphicon-home"></i> <b>Edit Produk</b></div>
				...
				<table class="table">
					...
					<tr>
                        ...
                        <span class="text-danger"><small>Gambar pertama akan dijadikan gambar utama.</small></span>
                              <input type="text" name="image1" value="" id="image1" class="form-control"  required />
                    ...
                    <?php
                    	for($i=2; $i<=8; $i++){
                    		...
                    		<tr>
		                        ...
		                        <th width="1%">:</th>
		                        <th width="45%">
		                              <input type="text" name="image<?php echo $i;?>" value="" id="image<?php echo $i;?>" class="form-control"/>
