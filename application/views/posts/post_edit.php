...
<div class="row">
	<div class="col-lg-12 col-sm-12 col-xs-12">
			...
			<div class="panel panel-primary">
				<div class="panel-heading"><i class="glyphicon glyphicon-tags"></i> <b>Edit Post</b></div>
				<div class="panel-body">
				<?php echo form_open('adminpost/edit/'.$this->uri->segment(3));?>
				...
				<table class="table">
					...
					<tr>
						...
						<?php
							echo anchor('adminpost','<i class="glyphicon glyphicon-backward"></i> Back',array(
